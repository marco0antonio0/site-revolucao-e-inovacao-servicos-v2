...
export default function SectionServicosBuild() {
    var itens = [
        {
    ...
    return <>
        <div className="w-[100%] flex flex-col m-auto mt-5 mb-20 px-[50px]">
            <h1 className=" text-4xl m-auto mt-4 font-medium  md:text-2xl ">Serviços</h1>
            <div className="flex flex-row gap-14 m-auto mt-12  max-w-[1500px] md:mt-8 xl:flex-col  xl:gap-10 flex-wrap align-middle items-center content-center">
                {itens.map((e, i) => {
                    return <>
                        <div className=" h-auto mb-10 xl:mb-0 flex flex-row max-w-[450px] w-[30%] xl:w-[100%] align-middle items-center content-center" >
